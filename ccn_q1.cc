#include <fstream> //used to create files ( like .pcap)
...
//
  ...
  p2p.EnableAscii(ascii.CreateFileStream ("Cycle1_Q1.tr"), dev);
  p2p.EnablePcap("Cycle1_Q1", dev, false);
...
//
  ...
  monitor->SerializeToXmlFile("Cycle1_Q1.flowmon", true, true);
